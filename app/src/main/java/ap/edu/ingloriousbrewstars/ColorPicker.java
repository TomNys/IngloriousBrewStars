...
public class ColorPicker extends Dialog implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            setContentView(com.pes.androidmaterialcolorpickerdialog.R.layout.materialcolorpicker__layout_color_picker_old_android);
        }
        ...
        redToolTip = (TextView)findViewById(com.pes.androidmaterialcolorpickerdialog.R.id.redToolTip);
        greenToolTip = (TextView)findViewById(com.pes.androidmaterialcolorpickerdialog.R.id.greenToolTip);
        blueToolTip = (TextView)findViewById(com.pes.androidmaterialcolorpickerdialog.R.id.blueToolTip);

        codHex = (EditText)findViewById(com.pes.androidmaterialcolorpickerdialog.R.id.codHex);
    ...
    private void updateColorView(String s) {
        if(s.matches("-?[0-9a-fA-F]+")){
            ...
            codHex.setError(c.getResources().getText(com.pes.androidmaterialcolorpickerdialog.R.string.materialcolorpicker__errHex));
        }
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (seekBar.getId() == com.pes.androidmaterialcolorpickerdialog.R.id.redSeekBar) {
